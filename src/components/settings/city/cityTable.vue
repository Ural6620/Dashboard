    ...
    <table class="min-w-full divide-y divide-gray-300">
      <thead>
        <tr>
          ...
          <th scope="col" class="th">Shahar/tuman nomi</th>
      ...
      <tbody class="bg-white">
        ...
        >
          ...
          <td class="td">{{ item.region?.translates?.at(1)?.title || '' }}</td>
          <td class="td">
...
const remove = async (answer) => {
  if (answer) {
    await store.removecity(_id.value)
  }
  close()
}
